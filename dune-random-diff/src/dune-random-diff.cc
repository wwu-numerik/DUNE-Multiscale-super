...
int main(int argc, char** argv)
{
    ...
    // Parameters
     ...
     try{
        ...
        //CroaseDiff coarsediff(log2seg -1, 1,corrLen,sigma, 1, log2seg);
        //TelescopicDiff simpleDiff(log2seg,1,corrLen,sigma,0,log2seg);
        //MultiLevelMonteCarloEst estimator(MPI_COMM_WORLD, tol);
        //estimator.addDifference(&coarsediff,32);
        //estimator.addDifference(&simpleDiff,6);
        //estimator.eval();
